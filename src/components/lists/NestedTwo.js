...
class NestedTwo extends Component {
  constructor(props) {
    super(props)
    this.state = {
      open: false,
...
export default withStyles(styles)(NestedTwo)